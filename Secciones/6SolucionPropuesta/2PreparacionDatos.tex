...
\begin{figure}[H]
  \centering
    ...
    \label{fig:venn}
\end{figure}
Finalmente, como se ve en la Figura~\ref{fig:venn}, se obtuvo una muestra de 260.000 estudiantes geo-referenciados del Gran Santiago con 93 columnas que representan indicadores o información de identificación de los alumnos. Desde ahora en adelante llamaremos variables a las columnas que no sean de identificación. Para ver un resumen del conjunto de datos y el libro de código, visitar el Anexo~\ref{an:muestra}.
