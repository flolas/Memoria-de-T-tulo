...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.9\textwidth]{Figuras/Clasificacion}
      \caption{Ejemplos de clasificación y regresión.\ref{scikitlearn2014}
...
%[cita] uru.edu [regresion logistica]
...
\begin{enumerate}
  \item Clasificación y Regresión
    ...
    \end{figure}
      ...
      %[cita] socivmyt [regresión lineal]
    ...
    %https://es.wikipedia.org/wiki/Función_log%C3%ADstica???? wikipedia????
      ...
      \begin{figure}[H]
        ...
        \includegraphics[width=0.7\textwidth]{Figuras/SVM}
         \caption{La frontera de decisión debe estar tan lejos de los datos de ambas clases como sea posible.%[cita]}
         \label{fig:svm}
      \end{figure}
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.9\textwidth]{Figuras/Precision}
      \caption{Descripción gráfica de precisión y exhaustividad.%[cita] preex}
    \label{fig:precision}
\end{figure}
