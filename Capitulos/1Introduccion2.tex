...
En el presente capítulo se hace una descripción detallada del contexto del proyecto de título, es decir, se presenta la importancia de la educación para luego pasar a describir en detalle al sistema de educación de Chile. Posterior a esto, se presenta la oportunidad detectada en el Sistema educativo nacional y los objetivos e ideas generales que se espera abordar.

Para comenzar, y antes de abordar el sistema educacional de Chile, es necesario dar cuenta de la importancia de la educación de forma transversal. La educación ha sido un tema muy importante a lo largo de la historia y más aún en la actualidad, ya que además de ser un derecho humano fundamental, es una herramienta mediante la cual es posible otorgarle a la sociedad considerables beneficios, no sólo la oportunidad de acceder a buenos puestos de trabajos con abundantes salarios, sino que también permite que un país se desarrolle gracias a la sociedad de calidad que la conforma. 
...
\section{El Sistema de Educación en Chile}

Para el contexto de Chile, a continuación se procederá a describir quiénes son los principales actores que intervienen en el proceso educativo, cómo este se imparte, la forma en que se toman decisiones en torno a la educación y los marcos legales que respaldan todo el sistema. 

\subsection{Entes reguladores y administradores de la educación chilena}
En Chile, existen diferentes entidades pertenecientes al Estado que intervienen de diferentes formas en el sistema educativo. A coninuación se presentan junto a sus respectivas funciones y objetivos. 

\subsubsection{Ministerio de Educación de Chile}
El Ministerio de Educación, MINEDUC, es la entidad del Estado encargada de asegurar el acceso a la educación a toda la población; fomentar el desarrollo de la educación en todos sus niveles; estimular la investigación científica, tecnológica y la creación artística, y la protección e incremento del patrimonio cultural de la Nación. Es también la encargada de velar por los derechos de todos los estudiantes, pertenezcan estos a establecimientos públicos o privados. 

Su misión es asegurar un sistema educativo inclusivo y de calidad que contribuya a la formación integral y permanente de las personas y al desarrollo del país, mediante la formulación e implementación de políticas, normas y regulación, desde la educación parvularia hasta la educación superior.

\textbf{Sistema Nacional de Evaluación del Desempeño de los Establecimientos Educacionales Subvencionados} \hfill \\
Es función del Ministerio de Educación que el sistema integrado por los establecimientos educacionales financiado con recursos públicos provea una educación gratuita y de calidad, fundada en un proyecto educativo público laico, respetuoso y pluralista, que permita el acceso a toda la población y que promueva la inclusión social y la equidad. Es por esto que resulta de gran importancia evaluar constantemente estos establecimientos financiados por el Estado chileno, por lo que en 1995 implementó el Sistema Nacional de Evaluación del Desempeño de los Establecimientos Educacionales Subvencionados, SNED, con el propósito de contribuir al mejoramiento de la calidad de la educación impartida por el sistema subvencionado del país.
...
\subsubsection{Consejo Nacional de Educación}
El Consejo Nacional de Educación, creado con base en la nueva Ley General de Educación\footnote{La Ley General de Educación se aborda con profundidad en la sección del Marco Legal.}, es un organismo autónomo con personalidad jurídica y patrimonio propio que se relaciona con el Presidente de la Repúbloca a través del Ministerio de Educación, y está formado por diez miembros presididos por el Ministro. En lo referido a la educación escolar, el Consejo se encarga de aprobar las bases curriculares, los planes y programas de estudio y el plan nacional de evaluaciones nacionales e internacionales de aprendizaje. También debe aprobar los Estándares de Aprendizaje de los estudiantes, los Estándares Indicativos de Desempeño para los establecimientos educacionales y sus sostenedores, y la metodología de Ordenación de los establecimientos educacionales.

\subsubsection{Agencia de Calidad de la Educación}
La Agencia de Calidad de la Educación, entidad creada en la nueva Ley General de Educación, es una institución del Gobierno de Chile que tiene como objetivo  evaluar y orientar el sistema educativo para ayudar al mejoramiento de la calidad y equidad de las oportunidades educativas, es decir, que todo alumno tenga las mismas oportunidades de recibir una educación de calidad. Por ello, dos de sus funciones centrales son evaluar y orientar al sistema educativo para contribuir al mejoramiento de la calidad de las oportunidades educativas. \cite{agenciacalidad}
...
\subsubsection{Superintendencia de Educación}
...
\subsubsection{Otras corporaciones autónomas relevantes}

\subsection{Establecimientos Educacionales}
\subsubsection{Proceso Educativo}
El proceso educativo en Chile está compuesto por niveles de enseñanza, que son diferentes etapas del proceso y buscan asegurar y facilitar la continuidad a lo largo del tiempo.
...
\end{enumerate}
\subsubsection{Clasificación de Establecimientos}
\subsubsection{Actores del Sistema Escolar}

\subsection{Jerarquía del sistema de educación en Chile}
\subsubsection{Nivel Regional}
\subsubsection{Nivel Provincial}
\subsubsection{Nivel Comunal}
...
De acuerdo a lo recién mencionado, existen tres tipos de instituciones que imparten la educación en el país.
...
Como es posible observar en la Figura~\ref{fig:esquema}, existe un trabajo en equipo entre las cuatro instituciones principales, donde la principal es el Ministerio de Educación de Chile, MINEDUC.
...
La función de las SEREMIs es planificar, normar y supervisar el de desarrollo del proceso educativo en los establecimientos ubicados en su territorio jurisdiccional, resguardando el cumplimiento de los objetivos y políticas educacionales y su correcta adecuación a las necesidades e intereses regionales. Les corresponderán, además, todas las funciones y atribuciones que las normas legales les otorgan, especialmente en materias técnico-pedagógicas y de inspección y control de subvenciones. 
\end{description}
...
CONICYT es una institución dependiente del Ministerio de Educación, fue creada en 1967 como organismo asesor de la Presidencia en materias de desarrollo científico. Sus grandes objetivos son dos: fomentar la formación de capital humano y el fortalecer la base científica y tecnológica del país. A su vez, ambos pilares son potenciados de manera transversal por una área de información científica y una de vinculación internacional. 
...
El Sistema Nacional de Aseguramiento de la Calidad de la Educación Escolar, SNAC, fue creado con la publicación de la Ley No 20529, promulgada el 11 de agosto de 2011. Establece el diseño de una nueva institucionalidad en educación, tal como se muestra anteriormente en la Figura~\ref{fig:esquema}. Esta comprende dos nuevos organismos: la Agencia de Calidad de la Educación y la Superintendencia de Educación.
