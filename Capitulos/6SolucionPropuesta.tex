...
\seccion{6SolucionPropuesta/1EntendimientoNegocioDatos}

\seccion{6SolucionPropuesta/2PreparacionDatos}

\seccion{6SolucionPropuesta/3Modelamiento}

\seccion{6SolucionPropuesta/4Evaluacion}

\seccion{6SolucionPropuesta/5Conclusiones}
